...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // 6. Interactive 3D Water Technology Experience (Three.js) (Disabled)
...
function initWebGL3DExperience() {
  ...
  scene.fog = new THREE.FogExp2(isDark ? 0x030712 : 0xf0f9ff, 0.015);
  ...
  window.addEventListener('themeChanged', (e) => {
    ...
    scene.fog.color.setHex(currentIsDark ? 0x030712 : 0xf0f9ff);
